                ...
                <div class="bg-gray-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2">
                    ...
                    <div class="p-6 border-t border-gray-200 md:border-t-0 md:border-l">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg text-gray-600 leading-7 font-semibold"><a href="#">Estado de cuenta</a></div>
                        </div>

                        <div class="ml-12">
                            <div class="mt-2 text-sm text-gray-500">
                                Veras todo el movimiento historico de tu cuenta, tu estado de cuenta actual. Tambien realizar consultas especificas e imprimir los documentos.
                            </div>

                            <a href="{{ route('user.account.status') }}">
                                <div class="mt-3 flex items-center text-sm font-semibold text-indigo-700">
                                        <div>Ir a mi estado de cuenta</div>
