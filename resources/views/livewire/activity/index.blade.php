                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    ...
                    <td class="px-6 py-4">
                        @forelse($activity->orders as $order)
                            {{ $loop->first ? '' : ', ' }}{{$order->reference}}
                        @empty
                            No hay ordenes en la Actividad.
                        @endforelse
                    </td>
                    <td class="px-6 py-4">
                        {{$activity->delivery_date == null ? 'Activo' : 'Finalizado'}}
                    </td>
                    <td class="px-6 py-4">
                    ...
                    <td class="px-6 py-4 text-right">
                        ...
                        @if($activity->delivery_date == null)
                            <a href="#" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Finalizar</a>
                        @endif
                    </td>
                </tr>
            @empty
